...
export class LoginComponent implements OnInit {
  ...
  initForm(): void {
    ...
    this.registerForm = new FormGroup({
      ...
      soiHouse: new FormControl(null, Validators.required),
      roadHouse: new FormControl(null, Validators.required),
      ...
      soiContact: new FormControl(null, Validators.required),
      roadContact: new FormControl(null, Validators.required),
      ...
      soiWork: new FormControl(null, Validators.required),
      roadWork: new FormControl(null, Validators.required),
